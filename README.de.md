...
| 15          | Zielstand: Und dann ist da noch die Version                 | `target-net10`                           | .NET 10, isolated, alle Auflösungen, plus zwei Zusatzbeispiele: DI-Prüfung beim Start (Worker 2.x) und `null` aus der Konfigurationsbindung                  |
